        ...
        child: Column(
          children: [
            Container(
              ...
              child: Row(children: [
                Text('user', style: TextStyle(color: AppColors.accentGreen, fontSize: 11)),
                Text('@', style: TextStyle(color: AppColors.textTertiary, fontSize: 11)),
                Text('init.habits', style: TextStyle(color: AppColors.accentCyan, fontSize: 11)),
                Text(':~\$', style: TextStyle(color: AppColors.textTertiary, fontSize: 11)),
                const SizedBox(width: 4),
                Text('auth.${_isSignUp ? 'signup' : 'login'}()',
              ...
              child: Center(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('// ${_isSignUp ? 'create account' : 'authenticate'}',
                          style: TextStyle(color: AppColors.textTertiary, fontSize: 10)),
                      const SizedBox(height: 4),
                      Text(_isSignUp ? r'$ create_account' : r'$ sign_in',
                          style: TextStyle(
                      ...
                      if (_error.isNotEmpty) ...[
                        Container(
                          ...
                          child: Text('stderr: $_error',
                              style: TextStyle(color: AppColors.accentRed, fontSize: 10)),
                        ),
